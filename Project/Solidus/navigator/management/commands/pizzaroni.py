...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for d in pizzaroni_jobs:
            parsed_data = Pizzaroni.objects.create(title=d['title'], picture_url=d['picture'], price=d['price'], url=d['url'], slug=cyrillic_to_latin(d['title']), description=fix_json_string(d['description']), website=d["website"], category="pizza")
            parsed_data.save()